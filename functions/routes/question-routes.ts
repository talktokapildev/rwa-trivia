...
// router.post('/:start/:size', questionAuth.authorizedOnly, questionController.getQuestions);
// router.post('/:questionId', questionAuth.authorizedOnly, questionController.getUpdatedQuestion);
router.post('/:start/:size', questionController.getQuestions);
router.post('/:questionId', questionController.getUpdatedQuestion);
